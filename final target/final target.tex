...
Tem-se assim que este é um bloco bastante compacto e com as ligações entre transístores simples, bastando que se verifiquem as regras mencionadas acima.

Mais uma vez utilizou-se um \textit{guard ring} protegendo e polarizando o circuito tal como foi dito nos blocos anteriores.
...
Feitas estas ligações, de forma a proteger ainda mais o circuito colocou-se um \textit{guard ring} em torno da forma final tal como se observa acima. Este \textit{guard ring} no entanto não é rectangular, tendo sido ajustado à forma do circuito final poupando-se ao máximo a área consumida.
...
\todo{comentar todos os pins q foram colocados no guard ring exterior dizendo que nao houve nenhum solto}
