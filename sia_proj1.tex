...
\begin{figure}[H]
	\centering
	\subfloat[]{\includegraphics[keepaspectratio=true, scale=0.60]{teoricas/rectangular}}
	\linebreak
	\subfloat[]{\includegraphics[keepaspectratio=true, scale=0.60]{teoricas/hamming}}
	\linebreak
	\subfloat[]{\includegraphics[keepaspectratio=true, scale=0.60]{teoricas/blackman}}
	\vspace{-0.8em}
