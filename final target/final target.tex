...
Após as correções os resultados são muito mais positivos, estando dentro dos requisitos do \textit{target}. O \textit{yeld} final é de 96\% para 50 \textit{runs}, que se considera um resultado bastante aceitável.
\todo{falar sobre a tal cena da realimentação e de como se podia ter 69 db de ganho}
