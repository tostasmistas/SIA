...
Em primeiro lugar foi decidido obter a \textit{SlewRate} desejada mas não comprometendo as restantes especificações, a solução encontrada foi aumentar a corrente que passa nos transístores $M_9$ e $M_{10}$ aumentado as suas dimensões de $W$ e $L$ e as dos transístores $M_3$ e $M_4$, esta alteração como já foi referido altera o efeito de segunda ordem. Com a \textit{SlewRate} próximo do valor pretendido segui-se o objectivo de reduzir a largura de banda e aumentar o ganho, observando as equações anteriores o aumento de $W$ e de $L$ dos transístores $M_7$ e $M_8$ traduz num aumento de $r_o$ e numa diminuição de $f_p$ e aumento do ganho, observar a iteração 2 na tabela seguinte. Obteve-se em contrapartida uma diminuição da \textit{SlewRate} tendo sido corrigida com o aumento de $W$ e $L$ dos transístores $M_9$ e $M_{10}$, iteração 3 da tabela, verificou-se que esta alteração não originava melhorias ao circuito, pelo contrário, aumentava a largura de banda e diminui-a o ganho.

Partindo da iteração 2, continuou-se a reduzir a largura de banda e aumentar o ganho, aumentando o $W$ e $L$ dos transístores $M_7$, $M_8$, $M_5$ e $M_6$ aumentando o $r_o$, iteração 4 e 5. De seguida optou-se por aumentar a margem de  fase, diminuiu-se o $W$ e o $L$ dos transístores $M_3$ e $M_4$ o que diminui o $V_{DB_9}$ aumentando a margem de fase, iteração 6. Continuou-se a com o objectivo de aumentar a margem de fase,           
